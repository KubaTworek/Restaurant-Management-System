...
ALTER TABLE Customer ADD CONSTRAINT Customer_Data
    FOREIGN KEY (Data_Id)
    REFERENCES PersonalData (Id);

-- Reference: Employee_Data (table: Employee)
ALTER TABLE Employee ADD CONSTRAINT Employee_Data
    FOREIGN KEY (Data_Id)
    REFERENCES PersonalData (Id);
...
ALTER TABLE MenuItem ADD CONSTRAINT MenuItem_Menu
    FOREIGN KEY (Menu_Id)
    REFERENCES Menu (Id);
...
ALTER TABLE Order_Employee ADD CONSTRAINT Order_Employee_Employee
    FOREIGN KEY (Employee_Id)
    REFERENCES Employee (Id);

-- Reference: Order_Employee_Order (table: Order_Employee)
ALTER TABLE Order_Employee ADD CONSTRAINT Order_Employee_Order
    FOREIGN KEY (Order_Id)
    REFERENCES "Order" (Id);

-- Reference: Order_MenuItem_MenuItem (table: Order_MenuItem)
ALTER TABLE Order_MenuItem ADD CONSTRAINT Order_MenuItem_MenuItem
    FOREIGN KEY (MenuItem_id)
    REFERENCES MenuItem (Id);

-- Reference: Order_MenuItem_Order (table: Order_MenuItem)
ALTER TABLE Order_MenuItem ADD CONSTRAINT Order_MenuItem_Order
    FOREIGN KEY (Order_Id)
    REFERENCES "Order" (Id);

-- Reference: Order_TypeOfOrder (table: Order)
ALTER TABLE "Order" ADD CONSTRAINT Order_TypeOfOrder
